...
const Navigation = ({ user, onLogout, currentTab, setCurrentTab }) => {
    return (
...
const App = () => {
    ...
    const renderCurrentTab = () => {
        switch(currentTab) {
            case 'dashboard':
                return <Dashboard campaigns={mockCampaigns} />;
            case 'history':
                return <History campaigns={mockCampaigns} />;
            case 'profile':
                return <Profile user={mockUser} campaigns={mockCampaigns} />;
            default:
                return <Dashboard campaigns={mockCampaigns} />;
        }
    };
